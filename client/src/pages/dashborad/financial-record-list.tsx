...
interface EditableCellProps extends CellProps<FinancialRecord>{
    updateLocalRecord: (rowIndex: number, columnId: string, value: any) => void; 
    editable: boolean;
}
...
const EditableCell: React.FC<EditableCellProps> = ({
    ...
    const onBlur = () => {
        setIsEditing(false);
        updateLocalRecord(row.index, column.id, value)
    }
...
export const FinancialRecordList = () => {
    ...
    const updateCellRecord = (rowIndex: number, columnId: string, value: any) => {
        ...
        // So this line basically replaces the columnId key with the new value, duplicate keys are replaced with new items using Spread Operator 
    ...
    const columns: Array<Column<FinancialRecord>> = useMemo(() => [
        {
            ...
            Cell: (props) => (
                <EditableCell
                   {...props} 
                   updateLocalRecord={updateCellRecord}
                   editable={true}
                />
            ),
        }, 
